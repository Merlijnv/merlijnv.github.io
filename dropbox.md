...
After some time with tinkering around with the autossh I tought it would be better to use a [reverse vpn](#revserse-vpn-gateway) that way I have full access over the machine not only ssh.
