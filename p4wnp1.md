...
![Covert channel shell](images/covertshell.png){: width="63%" align="left" display="inline-block"}
![p4wnp1 result](images/p4wnp1result.jpg){: width="37%" align="right" display="inline-block"}
